...
// }
let verletChain:VerletChain = new VerletChain(new THREE.Vector3(0, 0, .2), 
new THREE.Vector3(0, 0,-.2), 4, 0);
scene.add(verletChain);
verletChain.moveSegment(0, new THREE.Vector3(THREE.MathUtils.randFloatSpread(.00001), 
     THREE.MathUtils.randFloatSpread(.00001), THREE.MathUtils.randFloatSpread(.00001)));
