...
export class ProtoByte_0000 extends ProtoTubeBase {
    ...
    create() {
        ...
        let step = this.dim.y / this.tubeSegs;
        ...
        this.boneCount = 5;
        const spineGeom = new ProtoTubeGeometry(path, this.tubeSegs / 10, 20, false, { func: FuncType.SINUSOIDAL_INVERSE, min: 30, max: 80, periods: 3 }, this.boneCount);
