...
import { Tubemergence04 } from './Tubemergence04';
...
light.position.set(-15.2, 400.2, 30);
...
const pointLt = new PointLight(0xff0000, 1, 200); light.position.set(-75, 150, 90); scene.add(pointLt);
let ctr = 0;
function animate() {
