...
import { VerletBlockGeometry } from '../../../PByte3/VerletBlock';
import { TowerShake } from './TowerShake';
...
/****************** Custom geometry *******************/
let vb0Geom = new VerletBlockGeometry(new Vector3(40, 40, 40), new Vector3(1, 1, 1), .04);
/******************************************************/
