...
import { SingleCurve } from './SingleCurve';
...
function animate() {
    ...
    curve.rotateY(.03 * PI / 180);
    curve.rotateX(.06 * PI / 180);
    curve.rotateZ(-.01 * PI / 180);
    render();
}
