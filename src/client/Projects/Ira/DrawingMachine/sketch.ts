...
// Project Description: 
// Verlet Integrated Drawing Machine
...
const camera = new PerspectiveCamera(85, window.innerWidth / window.innerHeight, 0.01, 10000);
camera.position.x = 0;
