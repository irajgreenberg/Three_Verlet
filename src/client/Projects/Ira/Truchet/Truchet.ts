...
export class Truchet extends ProtoTubeBase {
    ...
    create() {
        ...
        this.boneCount = 5;
        const tubeGeom2 = new ProtoTubeGeometry(path2, tubeSegs, 12, false, { func: FuncType.SINUSOIDAL, min: 1, max: 2, periods: 1 }, this.boneCount);
        const tubeGeom1 = new ProtoTubeGeometry(path1, tubeSegs, 12, false, { func: FuncType.SINUSOIDAL, min: 1, max: 2, periods: 1 }, this.boneCount);
        const tubeGeom3 = new ProtoTubeGeometry(path3, tubeSegs, 12, false, { func: FuncType.SINUSOIDAL, min: 1, max: 2, periods: 1 }, this.boneCount);
        // this.curveLenth = tubeGeom.pathLen;
        // this.curveLengths = tubeGeom.pathSegmentLengths;
        ...
        this.tubeMesh = new Mesh(tubeGeom1, spineMat);
        let tubeMesh2 = new Mesh(tubeGeom2, spineMat);
        let tubeMesh3 = new Mesh(tubeGeom3, spineMat);
