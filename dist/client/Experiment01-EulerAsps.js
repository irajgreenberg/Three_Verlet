...
let aspCount = 75;
let aspTendrils = new Array(aspCount);
for (var i = 0; i < aspCount; i++) {
    aspTendrils[i] = new EulerStrand(new THREE.Vector3(THREE.MathUtils.randFloatSpread(.2), THREE.MathUtils.randFloatSpread(.2), THREE.MathUtils.randFloatSpread(.2)), new THREE.Vector3(THREE.MathUtils.randFloatSpread(.2), THREE.MathUtils.randFloatSpread(.2), THREE.MathUtils.randFloatSpread(.2)), THREE.MathUtils.randInt(25, 35), .1, .675);
