...
epidermalCover.setMaterials(new VerletMaterials(new THREE.Color(.8, .6, 8), /*node color*/ new THREE.Color(.8, .1, .9), /*spine color*/ .2, /*spine alpha*/ new THREE.Color(.7, 0, .6), /*slice color*/ .5, /*slice alpha*/ new THREE.Color(.7, .4, .6), /*tendril node color*/ new THREE.Color(.5, .3, .9), /*tendril color*/ .5, /*tendril alpha*/ new THREE.Color(.5, .8, 1), /*cilia node color*/ new THREE.Color(.5, .8, 1), /*cilia color*/ .2)); /*cilia alpha*/
...
epidermalHood.setMaterials(new VerletMaterials(new THREE.Color(.9, .9, .9), new THREE.Color(.9, .7, .7), .4, new THREE.Color(1, .5, 0), .4, new THREE.Color(.8, .8, .9), new THREE.Color(.8, .8, .9), .2, new THREE.Color(.8, .8, .9), new THREE.Color(.8, .8, .9), .4));
...
epidermalHood2.setMaterials(new VerletMaterials(new THREE.Color(.3, 0, .1), new THREE.Color(.5, 0, .2), .8, new THREE.Color(.6, .2, 0), .8, new THREE.Color(.5, .2, .2), new THREE.Color(.6, .5, .5), .5, new THREE.Color(.8, .8, .9), new THREE.Color(.8, .8, .9), .4));
