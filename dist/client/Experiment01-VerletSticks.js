...
for (var i = 0; i < stickCount; i++) {
    let tn1 = new VerletNode(new THREE.Vector3(THREE.MathUtils.randFloatSpread(.1), THREE.MathUtils.randFloatSpread(.1), THREE.MathUtils.randFloatSpread(.1)), THREE.MathUtils.randFloat(.002, .005));
    let tn2 = new VerletNode(new THREE.Vector3(THREE.MathUtils.randFloatSpread(.1), THREE.MathUtils.randFloatSpread(.1), THREE.MathUtils.randFloatSpread(.1)), THREE.MathUtils.randFloat(.002, .005));
    vSticks[i] = new VerletStick(tn1, tn2, THREE.MathUtils.randFloat(.001, .01), 0);
    scene.add(vSticks[i]);
    vSticks[i].moveNode(1, new THREE.Vector3(THREE.MathUtils.randFloatSpread(.01), THREE.MathUtils.randFloatSpread(.01), THREE.MathUtils.randFloatSpread(.01)));
}
// outer box
